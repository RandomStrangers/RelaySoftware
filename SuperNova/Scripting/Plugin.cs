    ...
    public abstract class Plugin 
    {
        ...
        public static bool Load(Plugin p, bool auto) {
            try {
                ...
                if (!String.IsNullOrEmpty(ver) && new Version(ver) > new Version(Server.Version2)) {
        ...
        public static void LoadAll() {
            ...
            LoadPlugin(new DiscordPlugin());
            LoadPlugin(new IRCPlugin());
            ...
            LoadPlugin(new RelayRoutePlugin());
            LoadPlugin(new RelayRoutePlugin1());
            LoadPlugin(new RelayRoutePlugin2());
