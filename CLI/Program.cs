...
namespace SuperNova.Cli {
  ...
  public static class Program {
        ...
        public static void Main(string[] args) {
            ...
            // If Relay_.dll is missing, a FileNotFoundException will get thrown for Relay dll
            try {
                EnableCLIMode();
            } catch (FileNotFoundException) {
                Console.WriteLine("Cannot start server as Relay_.dll is missing from " + Environment.CurrentDirectory);
            ...
            // separate method, in case Relay_.dll is missing
            StartCLI();
        }
#else
    public static class Program {
        ...
        static void LogNewerVersionDetected(object sender, EventArgs e) {
            Write("&cRelaySoftware update available! Update by replacing with the files from " + Updater.UploadsURL);
        }
#else
        static void LogNewerVersionDetected(object sender, EventArgs e) {
