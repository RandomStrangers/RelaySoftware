...
using RelaySoftware.Authentication;
using RelaySoftware.DB;
using RelaySoftware.Drawing;
using RelaySoftware.Events.EconomyEvents;
using RelaySoftware.Events.EntityEvents;
using RelaySoftware.Events.PlayerEvents;
using RelaySoftware.Events.PlayerDBEvents;
using RelaySoftware.Games;
using RelaySoftware.Maths;
...
namespace RelaySoftware {
    ...
    sealed class ConsolePlayer : Player {
        ...
        public override string FullName {
            get { return  Server.Config.ConsoleName; }
        }
