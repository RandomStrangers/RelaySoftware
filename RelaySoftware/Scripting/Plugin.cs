...
using RelaySoftware.Modules.Moderation.Notes;
using RelaySoftware.Modules.Relay.Discord;
using RelaySoftware.Modules.Relay.IRC;
using RelaySoftware.Modules.Relay1.Discord1;
using RelaySoftware.Modules.Relay1.IRC1;
using RelaySoftware.Modules.Relay2.Discord2;
using RelaySoftware.Modules.Relay2.IRC2;
using RelaySoftware.Modules.Security;
using RelaySoftware.Scripting;

namespace RelaySoftware
{
    /// <summary> This class provides for more advanced modification to RelaySoftware </summary>
    public abstract class Plugin
    {
        ...
        /// <summary> Oldest version of RelaySoftware this plugin is compatible with. </summary>
        public virtual string SuperNova_Version { get; }
