/*
    Copyright 2010 MCLawl Team - Written by Valek (Modified by RelaySoftware)

    Edited for use with RelaySoftware
...
namespace RelaySoftware.Scripting
{
