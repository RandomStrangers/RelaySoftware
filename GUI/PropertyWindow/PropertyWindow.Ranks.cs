...
namespace RelaySoftware.Gui {
    ...
    public partial class PropertyWindow : Form {
...
#if DEV_BUILD_NOVA
            Server.Config.OSPerbuildDefault = GuiPerms.GetPermission(rank_cmbOsMap, LevelPermission.Nova);
#else
        ...
        void rank_btnAdd_Click(object sender, EventArgs e) {
            ...
            int perm = 5;
#if DEV_BUILD_NOVA
            for (int i = (int)LevelPermission.Guest; i <= (int)LevelPermission.Nova; i++) {
#else
